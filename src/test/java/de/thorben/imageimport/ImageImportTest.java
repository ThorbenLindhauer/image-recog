...
public class ImageImportTest {
	...
	public void testImport() {
		...
		Image image = importer.loadSingleImage(ImageImportTest.class
				.getResource("../../../face/test.pgm").getPath());
	...
	@Test
	public void testImportWithComments() {
		ImageImporter importer = new ImageImporter(128, 120);

		String imagePath = ImageImportTest.class
				.getResource("../../../face/testWithComment.pgm").getPath();
		Image image = importer.loadSingleImage(imagePath);

		// TODO assert correct import
	}
}
